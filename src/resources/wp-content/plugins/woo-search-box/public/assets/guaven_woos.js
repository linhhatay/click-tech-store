(function($) {
    ...
    guaven_woos.backend_preparer_direct = function(searchterm) {
        ...
        var gws_resubmit = setInterval(function() {
            if (prids_object === null || prids_object == undefined || prids_object.length == 0) {
                return;
            } else {
                clearInterval(gws_resubmit);
            }
    ...
    window.gws_tempval_filter = function(str) {
        return str;
    }
    ...
    function gws_currency_solver() {
        ...
        if (guaven_woos.woo_multicurrency != undefined) {
            gws_current_currency = 2;
            woocs_current_currency = guaven_woos.woo_multicurrency;
        }
    ...
    function gws_simple_expression_response(gws_parceprice, gws_parceprice_final, guaven_woos_temphtml, current_segment, current_segment_text) {
        ...
        if (pureprice != 'null') {
            ...
            else if (current_segment == 2 && pureprice_final < gws_parceprice_final) {
                cont = 'continue';
            } else if (current_segment == 0 && pureprice_final > gws_parceprice_final) {
                cont = 'continue';
            }
        }
        return cont;
    ...
    function gws_simple_expression_scanner(guaven_woos_tempval_raw) {
        ...
        gws_current_segment = 1;
        gws_current_segment_text = '';
        for (var j = 0; j < guaven_woos.expression_segments.length; j++) {
            if (guaven_woos_tempval_raw_in.indexOf(guaven_woos.expression_segments[j]) > -1) {

                gws_current_segment = j;
                gws_current_segment_text = guaven_woos.expression_segments[j];
            }
        }
    ...
    jQuery(document).ready(function() {
        ...
        jQuery(document).on('keyup', guaven_woos.selector, function(e) {
            if (typeof guaven_woos.cache_keywords == "undefined") {
                gws_queued_object = jQuery(this);
            }
        });
