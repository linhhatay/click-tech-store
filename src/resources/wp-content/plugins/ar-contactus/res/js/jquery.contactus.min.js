...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(c, d, a) {
...
$jscomp.polyfill = function(c, d, a, b) {
    if (d) {
        ...
        b = a[c];
        d = d(b);
        d != b && null != d && $jscomp.defineProperty(a, c, {
            configurable: !0,
            writable: !0,
            value: d
        })
...
(function(c) {
    ...
    d.prototype._initCallbackFormFields = function(a) {
        ...
        c.each(b.settings.callbackFormFields, function(e) {
            var d = c("<div>", {
                    class: "arcu-form-group arcu-form-group-type-" + b.settings.callbackFormFields[e].type + " arcu-form-group-" + b.settings.callbackFormFields[e].name + (b.settings.callbackFormFields[e].required ? " arcu-form-group-required" : "")
                }),
                h = "<input>";
    ...
    d.prototype._initMessengersBlock = function() {
        ...
        b.append(e);
        a.append(b);
        "elastic" == this.settings.style ? (b = '<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 800" preserveAspectRatio="none"><path d="M-1,0h101c0,0-97.833,153.603-97.833,396.167C2.167,627.579,100,800,100,800H-1V0z"/></svg>', e = c("<div>", {
                class: "arcu-morph-shape",
                id: "arcu-morph-shape",
                "data-morph-open": "M-1,0h101c0,0,0-1,0,395c0,404,0,405,0,405H-1V0z"
            }),
            e.append(b), a.append(e)) : "bubble" == this.settings.style && (b = '<svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 100 800" preserveAspectRatio="none"><path d="M-7.312,0H0c0,0,0,113.839,0,400c0,264.506,0,400,0,400h-7.312V0z"></path><defs></defs></svg>', e = c("<div>", {
                class: "arcu-morph-shape",
                id: "arcu-morph-shape",
    ...
    d.prototype._appendMessengerIcons = function(a) {
        ...
        c.each(this.settings.items, function(e) {
            e = c("<li>", {});
            if ("callback" == this.href) var d = c("<div>", {
                class: "messanger call-back " + (this.class ? this.class : "")
            });
            else if ("_popup" == this.href) b.popups.push(this), d = c("<div>", {
            ...
            g.text(this.title);
            f.append(g);
            "undefined" != typeof this.subTitle && this.subTitle && (g = c("<div>", {
    ...
    d.prototype._initEvents = function() {
        ...
        a.find(".arcontactus-message-button").on("mousedown", function(a) {
            ...
            if (b.settings.drag && a.pageX === b.x && a.pageY === b.y || !b.settings.drag) "regular" == b.settings.mode ? b._menuOpened || b._popupOpened || b._callbackOpened ? (b._menuOpened && b.closeMenu(), b._popupOpened && b.closePopup()) : b.openMenu() : b.openCallbackPopup(), a.preventDefault()
        });
        ...
        a.find("#arcu-callback-form").on("submit", function(c) {
            ...
            b.settings.reCaptcha ? grecaptcha.execute(b.settings.reCaptchaKey, {
                action: b.settings.reCaptchaAction
            }).then(function(c) {
    ...
    d.prototype.openMenu = function() {
        ...
        if ("elastic" ==
            this.settings.style) this.svgPath.animate({
    ...
    d.prototype.closeMenu = function() {
        ...
        if ("elastic" == this.settings.style || "bubble" == this.settings.style) jQuery("body").removeClass("arcu-show-menu").removeClass("arcu-menu-" +
            this.settings.align), setTimeout(function() {
        ...
        a.find(".messangers-block").hasClass(this.settings.menuInAnimationClass) && (setTimeout(function() {
            ...
            }, 1E3), a.find(".arcontactus-close").removeClass("show-messageners-block"),
    ...
    d.prototype.startAnimation = function() {
        ...
        this._interval = setInterval(function() {
            ...
            l > g && (l > g + 1 && (m.settings.iconsAnimationPause && (m.stopAnimation(), setTimeout(function() {
                ...
                l = 0), b.parent().addClass("hide"), c.removeClass("hide"), a = "translate(" + -h + "px, " + f + "px)", b.css({
                "-webkit-transform": a,
                "-ms-transform": a,
                transform: a
            }))
