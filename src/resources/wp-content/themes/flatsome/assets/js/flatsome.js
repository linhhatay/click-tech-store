        ...
        a.prototype = {
            ...
            open: function(i) {
                ...
                if (!e.isOpen) {
                    ...
                    e.fixedContentPos && (e.isIE7 ? t("html").css("overflow", "hidden") : g.overflow = "hidden");
            ...
            _close: function() {
                ...
                if (e.bgOverlay.detach(), e.wrap.detach(), e.container.empty(), e.st.mainClass && (i += e.st.mainClass + " "), e._removeClassFromMFP(i), e.fixedContentPos) {
                    ...
                    e.isIE7 ? t("html").css("overflow", "") : o.overflow = "", t("html").css(o)
                }
    ...
    Flatsome.behavior("toggle", {
        attach: function(t) {
            ...
            jQuery([".widget ul.children", ".nav ul.children", ".menu .sub-menu", ".mobile-sidebar-levels-2 .nav ul.children > li > ul"].join(", "), t).each((function() {
                ...
                jQuery(this).parent().addClass("has-child").attr("aria-expanded", "false"), jQuery(this).before('<button class="toggle"><i class="fal fa-angle-'.concat(t, '"></i></button>'))
...
jQuery(document).ready(function() {
    if (jQuery('.woocommerce-Tabs-panel--description-container').height() > 700) {
        jQuery('.woocommerce-Tabs-panel--description-container').addClass('long-content');
        jQuery('.woocommerce-Tabs-panel--description-wrap').append('<div class="woocommerce-Tabs-panel--description-overlay"></div>');
        jQuery('.woocommerce-Tabs-panel--description-wrap').append('<div class="woocommerce-Tabs-panel--description-expand"><span class="view-more">Xem thêm <i class="fa-regular fa-angle-down"></i></span></div>')
    }
});

jQuery(document).ready(function() {
    jQuery('.woocommerce-Tabs-panel--description-expand').click(function() {
        jQuery('.woocommerce-Tabs-panel--description-container').addClass('active');
        jQuery('.woocommerce-Tabs-panel--description-overlay').addClass('disabled');
        jQuery('.woocommerce-Tabs-panel--description-expand').addClass('expanded')
    });
});

jQuery(document).ready(function() {
    jQuery("#click-description").click(function() {
        jQuery([document.documentElement, document.body]).animate({
            scrollTop: jQuery("#tab-description").offset().top - 20
        }, 500);
    });
});

jQuery(document).ready(function() {
    jQuery("#click-reviews, .product_meta .woocommerce-product-rating").click(function() {
        jQuery([document.documentElement, document.body]).animate({
            scrollTop: jQuery("#tab-reviews").offset().top + 1
        }, 500);
    });
});

jQuery(document).ready(function() {
    jQuery("#click-cart").click(function() {
        jQuery([document.documentElement, document.body]).animate({
            scrollTop: jQuery(".shop-container").offset().top
        }, 500);
    });
});